...
-- Clock
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", space3 .. "%H:%M   " .. markup.font("Courier 10 Pitch for Powerline 5", " ")))
...
-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#FFFFFF", space3 .. "%d %b " .. markup.font("Abril Fatface 5", " ")))
...
theme.cal = lain.widget.cal({
    ...
    notification_preset = {
        ...
        font = "Courier 10 Pitch for Powerline 10"
    }
})
...
theme.fs = lain.widget.fs({
    notification_preset = { bg = theme.bg_normal, font = "FreeSerif 9" },
})
--]]
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "FreeSerif 9", position = "bottom_right" },
})
...
-- Separators
local first = wibox.widget.textbox('<span font="Roboto 1"> </span>')
...
--- wibar mouse click bindings end here--}}}
function theme.at_screen_connect(s)
    ...
    local layouts = { l.tile, l.tile, l.floating, l.fair, l.max, l.floating, l.floating, l.floating, l.fair }
awful.tag(names, s, layouts)
    ...
    s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.noempty, awful.util.taglist_buttons, { bg_focus = barcolor })
